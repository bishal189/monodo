...
const storyParagraphs = [
  "Momondo is a fully-serviced representation agency, specialising in the travel and tourism industry and providing representation in the UK and Ireland. You’ll find a close, friendly team who have all grown and are growing within the industry, and between them there’s over 200 years of experience. Their clients are a range of destinations, tourist attractions and airlines. Momondo is a professional, proactive and creative team who take pride in their work to ensure they provide tailored initiatives that maximise return on investment.",
  "The committed team provides high quality, personable services using their in-house skills and knowledge as well as their extensive contacts both in travel and media, to deliver results in line with a client’s goals and objectives. Services range from the very best in sales, PR, media, marketing and more within travel trade and consumer markets. If you’re looking for long or short term targets Momondo can deliver as they listen, strategically plan, are creative, understand the audience and deliver prompt results in a decisive and professional manner.",
];
